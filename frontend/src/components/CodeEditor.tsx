  ...
  return (
    <div className="max-w-6xl mx-auto space-y-6">
      ...
      <div className="bg-white rounded-lg shadow-lg p-6">
        <h2 className="text-2xl font-semibold text-gray-800 mb-4">Python Code Editor</h2>
      ...
      <div className="bg-blue-50 rounded-lg p-6">
        <h3 className="text-lg font-semibold text-blue-800 mb-2">Available Libraries</h3>
        <p className="text-blue-700 mb-2">
          The following Python libraries are pre-installed and ready to use:
        </p>
        <ul className="list-disc list-inside text-blue-600 space-y-1">
          <li><code className="bg-blue-100 px-1 rounded">pandas</code> - Data manipulation and analysis</li>
          <li><code className="bg-blue-100 px-1 rounded">scipy</code> - Scientific computing</li>
          <li><code className="bg-blue-100 px-1 rounded">numpy</code> - Numerical computing</li>
        </ul>
        <div className="mt-4 text-sm text-blue-600">
          <p><strong>Test Code:</strong> Execute code without saving to database</p>
          <p><strong>Submit:</strong> Execute code and save successful results to database</p>
        </div>
      </div>
    </div>
  )
